...
public class AirConditionerServiceTest {
    ...
    public void insert() throws IOException {
        ...
        // 准备一些空调品牌
        String[] brands = { "米家空调", "米家互联网空调", "米家互联网空调（一级能效）", "DAIKIN 大金", "三菱电机", "PANASONIC 松下", //
                "三菱重工", "HAIER 海尔", "格力", "美的", "TCL", "格兰仕" };
        ...
        for (int i = 0; i < length; i++) {
            ...
            AirConditionerVO airConditionerVO =
                    ...
                    .seller(sellers[sellerIndex]).address(regions[regionIndex].getRegion()).build();
